...
\documentclass[
    ...
    TitleEng        = {High Accuracy and Real-time Instance-level Object Pose Estimation}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{高精实时的实例级}{6D物体位姿估计技术}
...
\titleengthreelines{High Accuracy and}{Real-time Instance-level}{Object Pose Estimation}
