...
\documentclass[
    ...
    % Title
    Title           = 基于深度学习的6D物体位姿估计技术研究,
    TitleEng        = Research on Object Pose Estimation Techniques Based on Deep Learning
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{基于深度学习的6D}{物体位姿估计技术研究}
\titleengtwolines{6D Object Pose Estimation}{ Based on Deep Learning}
