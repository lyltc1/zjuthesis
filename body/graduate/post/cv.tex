...
\begin{enumerate}
    % Yongliang Lin, Yongzhi Su, Praveen Nathan, Sandeep Inuganti, Yan Di, Martin Sundermeyer, Fabian Manhardt, Didier Stricker, Jason Rambach and Yu Zhang. 
    ...
    % Yongliang Lin, Chun Her Lim, Song Jin, Wen Yang, Yu Zhang. 
    ...
    % Yongliang Lin, Wen Yang, Song Jin, Chun Her Lim, Yu Zhang. 
...
\section*{其他论文}
\begin{enumerate}
    % Hanqing Yang, Yongliang Lin, Hong Zhang, Yu Zhang and Bin Xu. 
    ...
    % Zhangzhen Zhu, Yongliang Lin and Yu Zhang. 
