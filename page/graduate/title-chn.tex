...
\begin{center}
    ...
    \begin{tabularx}{.7\textwidth}{>{\fangsong}r >{\fangsong}X<{\centering}}
        答辩委员会主席： & \uline{\hfill 吴俊 \hfill} \\
        委员1： &  \uline{\hfill 宋春跃 \hfill} \\
        委员2： &  \uline{\hfill 徐祖华 \hfill} \\
        委员3： &  \uline{\hfill 蒋鹏 \hfill} \\
        委员4： &  \uline{\hfill 刘毅 \hfill} \\
    \end{tabularx}
\end{center}
...
\begin{center}
    ...
    \begin{tabularx}{.45\textwidth}{>{\fangsong}l >{\fangsong}X<{\centering}}
        答辩日期 & \uline{\hfill 2025.06.03 \hfill}
    \end{tabularx}
\end{center}
